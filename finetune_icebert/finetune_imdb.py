...
model_save_dir = "elenaovv/model_imdb_processed"
...
train = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/imdb/train.txt', sep='\t', header=None, names=['text', 'label'])
test = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/imdb/test.txt', sep='\t', header=None, names=['text', 'label'])
validation = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/imdb/validation.txt', sep='\t', header=None, names=['text', 'label'])
...
training_args = TrainingArguments(
    output_dir=os.path.join(parent_dir, "Models_imdb_processed/results/" + model_save_dir),
...
model.save_pretrained(os.path.join(parent_dir, "Models_imdb_processed/" + model_save_dir))