...
train = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/igc_full/train.txt', sep='\t', header=None, names=['text', 'label'])
test = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/igc_full/test.txt', sep='\t', header=None, names=['text', 'label'])
validation = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/igc_full/validation.txt', sep='\t', header=None, names=['text', 'label'])
...
training_args = TrainingArguments(
    output_dir=os.path.join(parent_dir, "Models_2/results/" + model_save_dir),
...
model.save_pretrained(os.path.join(parent_dir, "Models_2/" + model_save_dir))