...
train = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/igc_1_3/train.txt', sep='\t', header=None, names=['text', 'label'])
test = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/igc_1_3/test.txt', sep='\t', header=None, names=['text', 'label'])
validation = pd.read_csv('/users/home/elenao23/2_finetuning_fix/data/igc_1_3/validation.txt', sep='\t', header=None, names=['text', 'label'])
...
training_args = TrainingArguments(
    output_dir=os.path.join(parent_dir, "Models_igc_1_3/results/" + model_save_dir),
...
# Optionally, add a callback to print metrics after each epoch
...
model.save_pretrained(os.path.join(parent_dir, "Models_igc_1_3/" + model_save_dir))